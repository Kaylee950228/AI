...
public class Simulator {
     ...
     */
    public Simulator(ProblemSpec ps, String outputFile, boolean verbose) {
        this.ps = ps;
        this.outputFile = outputFile;
        this.writeOutput = outputFile != null;
     ...
     */
    public Simulator(String inputFile, String outputFile, boolean verbose) throws IOException {
        this(new ProblemSpec(inputFile), outputFile, verbose);
    }
    ...
    public StateTuple myStep(Action a) throws IllegalArgumentException {

        State nextState;
        boolean fromSlip = false;
        ...
        return new StateTuple(nextState, fromSlip, fromBreakdown);
    }
     ...
     */
    public void outputSteps(boolean goalReached) {
