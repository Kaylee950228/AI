...
public class Action {
    ...
    public boolean equals(Object o) {
        ...
        return fuel == action.fuel &&
                ...
                Objects.equals(carType, action.carType) &&
                Objects.equals(driverType, action.driverType) &&
                tireModel == action.tireModel &&
                tirePressure == action.tirePressure &&
                Objects.equals(text, action.text);
    }

    @Override
    public int hashCode() {
        return Objects.hash(actionType, carType, driverType, tireModel, fuel, tirePressure, text);
    }
